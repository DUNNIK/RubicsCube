...
ofstream fout ("rubikscubecommands");

CubicRubica::CubicRubica() = default;
CubicRubica::~CubicRubica() = default;
void CubicRubica::display(char face[9])
{
    for(int i=0;i<9;i++)
    {
        cout<<face[i]<<" ";
...
void CubicRubica::white_bottom(char q)
{
...
void CubicRubica::inv_alg(char a,char b,char c)
{
...
void CubicRubica::white_bottom_inverted(char q)
{
...
void CubicRubica::solve_white_cross()
{
    if (is_it_full()){
        return;
    }
...
void CubicRubica::middle_place_left_alg(char left,char center)
{
    rotate_clock('y');rotate_clock('y');rotate_clock('y');
...
void CubicRubica::middle_place_right_alg(char center,char right)
{
    rotate_clock('y');
    rotate_clock(right);
    rotate_clock('y');rotate_clock('y');rotate_clock('y');
...
void CubicRubica::solve_middle_layer()
{
    if (is_it_full()){
        return;
    }
...
void CubicRubica::yellow_cross_algorithm()
{
    rotate_clock('r');
    rotate_clock('y');
    rotate_clock('g');
...
void CubicRubica::solve_yellow_cross()
{
    if (is_it_full()){
        return;
    }
...
void CubicRubica::yellow_corners_algorithm()
{
    rotate_clock('g');
    rotate_clock('y');
    rotate_clock('g');rotate_clock('g');rotate_clock('g');
...
void CubicRubica::solve_yellow_corners()
{
    if (is_it_full()){
        return;
    }
...
void CubicRubica::yellow_corner_orientation_algorithm()
{
    rotate_clock('g');rotate_clock('g');rotate_clock('g');
    rotate_clock('r');
    rotate_clock('g');rotate_clock('g');rotate_clock('g');
...
void CubicRubica::yellow_corner_orientation()
{
    if (is_it_full()){
        return;
    }
...
void CubicRubica::yellow_edges_colour_arrangement_right()
{
...
void CubicRubica::yellow_edges_colour_arrangement_left()
{
    rotate_clock('r');rotate_clock('r');
    rotate_clock('y');
    rotate_clock('b');
...
void CubicRubica::yellow_edges_colour_arrangement()
{
    if (is_it_full()){
        return;
    }
